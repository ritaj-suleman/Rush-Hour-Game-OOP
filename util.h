...
void DrawLine(int x1, int y1, int x2, int y2, int lwidth = 3,const float *color =
		NULL);
...
void DrawRoundRect(float x, float y, float width, float height,
		const float* color = 0, float radius = 0.0);
// Function draws a string at given x,y coordinates
void DrawString(int x, int y, int width, int height, const string& str,const
		float * color = NULL);
void DrawString(float x, float y, const string& str,const float * color = NULL);
 ...
 * */
void DrawTriangle(int x1, int y1, int x2, int y2, int x3, int y3,const float *color);
// Draws a rectangle of the specified color
void DrawRectangle(int sx, int sy, int width, int height, const float *color);
